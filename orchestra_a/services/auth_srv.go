...
func NewAuthService(user_repo domain.UserRepository, profile_srv ProfileService) AuthService {
	return authService{user_repo: user_repo, profile_srv: profile_srv}
}
...
func (srv authService) SignUp(credential SignUpRequest) (*TokenData, error) {
	...
	// create new profile
	if err := srv.profile_srv.CreateNewProfile(ProfileRequest{
